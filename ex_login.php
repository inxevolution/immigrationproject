...
$confemaildb = "SELECT * FROM user, p_conf  WHERE user.email = '$email' and p_conf.password = '$pass_crypt' and p_conf.contaativa = 'activa' ";
                                    $result_db = mysqli_query($ligacao, $confemaildb);
                                    $row = mysqli_num_rows($result_db);
                                       
                                    /*
                                        $resultado_print = mysqli_fetch_array($resultado_dbid);
                                    ...
                                    */
                                    ...
                                    if ($row == 0)
                                    {
                                        ...
                                        $select_ip = "SELECT * FROM v_login WHERE ip = '$ip_cli' and  id_user = '$id_user' and estado = '0' ";
                                        ...
                                        if (!$resultado_ip)
                                        {
                                            ...
                                            $upt_ip = "UPDATE `v_login` SET `estado` = '1' WHERE `v_login`.`id_user` = '$id_user';";
