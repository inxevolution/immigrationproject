                        ...
                        <div class="col-sm-8 col-sm-offset-2">
                            ...
                            if ($rowsn == 0)
                            {
                                ...
                                if(!$send_mail) {
                                    ...
                                    $sql="INSERT INTO `log_user` (`id_user`, `name`, `email`, `id_office`, `id_payment`, `cpf`, `datebirthday`, `city`, `adress`, `number`, `id_country`) VALUES (NULL, '$name', '$email', '1', '0', '$cpf', '$datanascimento', ' ', ' ', ' ', ' ');";
