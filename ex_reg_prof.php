                        ...
                        <div class="col-sm-8 col-sm-offset-2">
                            ...
                            {                                
                                ...
                                if(!$send_mail) {
                                    ...
                                    $sql="INSERT INTO `log_prof` (`id_prof`, `name`, `email`, `id_office`, `id_pclass`, `id_payment`, `cpf`, `datebirthday`, `id_country`, `city`, `adress`, `number`) VALUES (NULL, '$name', '$email', '2', '1', '0', '$cpf', '$datanascimento', ' ', ' ', ' ', ' ');";
